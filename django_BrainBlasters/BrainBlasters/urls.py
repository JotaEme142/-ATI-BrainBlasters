...
from myapp.views import home_jugador, seleccionarcategoria, respondercategoria, perfil_jugador, procesar_respuesta, editar_perfil, help, set_language, ranking, trivia_sorpresa
